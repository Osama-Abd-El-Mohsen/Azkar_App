...
requirements = python3, kivy==2.3.0, https://github.com/kivymd/KivyMD/archive/master.zip, materialyoucolor, exceptiongroup, asyncgui, asynckivy,libffi, Pillow,python-bidi,arabic_reshaper,plyer==2.0.0,oscpy,pandas 
